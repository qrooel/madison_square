<?php /* Smarty version 2.6.19, created on 2012-10-09 06:20:35
         compiled from /home/qrooel/public_html/ac.vipserv.org/madison_square2/design/frontend/core/productsearchlistbox/index/pagination.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'seo', '/home/qrooel/public_html/ac.vipserv.org/madison_square2/design/frontend/core/productsearchlistbox/index/pagination.tpl', 7, false),)), $this); ?>
<ul>
...
<?php echo smarty_function_seo(array('controller' => $this->_tpl_vars['controller'],'seo' => $this->_tpl_vars['searchPhrase'],'page' => $this->_tpl_vars['dataset']['previousPage'],'price' => $this->_tpl_vars['priceRange'],'producers' => $this->_tpl_vars['currentProducers'],'attributes' => $this->_tpl_vars['currentAttributes']), $this);?>
">Poprzednia</a></li>
	<?php endif; ?>
<?php endif; ?>
	<li class="page <?php if ($this->_tpl_vars['dataset']['totalPages'][$this->_sections['links']['index']] == $this->_tpl_vars['dataset']['activePage']): ?>active<?php endif; ?>" ><a id="<?php echo $this->_tpl_vars['dataset']['totalPages'][$this->_sections['links']['index']]; ?>
"  href="<?php echo $this->_tpl_vars['URL']; ?>
<?php echo smarty_function_seo(array('controller' => $this->_tpl_vars['controller'],'seo' => $this->_tpl_vars['searchPhrase'],'page' => $this->_tpl_vars['dataset']['totalPages'][$this->_sections['links']['index']],'price' => $this->_tpl_vars['priceRange'],'producers' => $this->_tpl_vars['currentProducers'],'attributes' => $this->_tpl_vars['currentAttributes']), $this);?>
...
<?php echo smarty_function_seo(array('controller' => $this->_tpl_vars['controller'],'seo' => $this->_tpl_vars['searchPhrase'],'page' => $this->_tpl_vars['dataset']['nextPage'],'price' => $this->_tpl_vars['priceRange'],'producers' => $this->_tpl_vars['currentProducers'],'attributes' => $this->_tpl_vars['currentAttributes']), $this);?>
">Następna</a></li>
	<?php endif; ?>
<?php endif; ?>
<?php endfor; endif; ?>
