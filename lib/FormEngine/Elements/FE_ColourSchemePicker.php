...
class FE_ColourSchemePicker extends FE_TextField {
	...
	public function __construct($attributes) {
		...
		$this->_attributes['file_types_description'] = App::getRegistry()->core->getMessage('TXT_FILE_TYPES_IMAGE');
		$this->_attributes['upload_url'] = App::getURLAdressWithAdminPane() . 'files/add';
	...
	protected function _PrepareAttributes_JS() {
		$attributes = Array(
			...
			$this->_FormatAttribute_JS('type_colour', 'bAllowColour', FE::TYPE_BOOLEAN),
			$this->_FormatAttribute_JS('type_gradient', 'bAllowGradient', FE::TYPE_BOOLEAN),
			$this->_FormatAttribute_JS('type_image', 'bAllowImage', FE::TYPE_BOOLEAN),
			...
			$this->_FormatAttribute_JS('type_icons', 'oTypeIcons', FE::TYPE_OBJECT),
			$this->_FormatAttribute_JS('file_types_description', 'sFileTypesDescription'),
			$this->_FormatAttribute_JS('delete_handler', 'fDeleteFile', FE::TYPE_FUNCTION),
