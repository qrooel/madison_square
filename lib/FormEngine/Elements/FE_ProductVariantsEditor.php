 ...
 * a copy immediately.
 */
class FE_ProductVariantsEditor extends FE_Field {
	...
	public function __construct ($attributes) {
		...
		$this->_attributes['photos'] = $this->getSelectedPhotosById((int) App::getRegistry()->core->getParam());
	...
	public function getSelectedPhotosById ($id) {
		$sql = 'SELECT 
					F.name,
					F.idfile
