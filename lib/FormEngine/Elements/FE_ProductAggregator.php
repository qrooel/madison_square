...
class FE_ProductAggregator extends FE_Field {
	
	protected $_jsFunction;
	
	public function __construct($attributes) {
		parent::__construct($attributes);
		if (!isset($this->_attributes['products_source_field']) || !($this->_attributes['products_source_field'] instanceof FE_ProductSelect)) {
	...
	protected function _PrepareAttributes_JS() {
		$attributes = Array(
			...
			$this->_FormatAttribute_JS('jsfunction', 'fLoadProductData', FE::TYPE_FUNCTION)
		);
		return $attributes;
	}
