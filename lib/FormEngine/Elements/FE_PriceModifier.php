...
class FE_PriceModifier extends FE_Price {
	
	public function __construct($attributes) {
		parent::__construct($attributes);
		if (!isset($this->_attributes['base_price_field']) || !($this->_attributes['base_price_field'] instanceof FE_Field)) {
	...
	protected function _PrepareAttributes_JS() {
		$attributes = Array(
			...
			$this->_FormatAttribute_JS('suffixes', 'oSuffixes', FE::TYPE_OBJECT),
