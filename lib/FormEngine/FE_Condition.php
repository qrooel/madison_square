...
abstract class FE_Condition {

	protected $_jsConditionName;
	protected $_argument;

	public function __construct($argument) {
		$this->_jsConditionName = 'GFormCondition.' . strtoupper(substr(get_class($this), strlen('FE_Condition')));
	...
	public function Render_JS() {
		...
		if (is_array($this->_argument) and isset($this->_argument[0]) and ($this->_argument[0] instanceof FE_Condition)) {
			$parts = Array();
