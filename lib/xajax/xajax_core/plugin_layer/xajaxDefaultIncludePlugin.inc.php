...
/*
	@package xajax
	@version $Id: xajaxDefaultIncludePlugin.inc.php 95 2011-04-30 13:23:53Z gekosale $
...
//
//		if (0 == count($aJsFiles)) {
//			$aJsFiles[] = array($this->_getScriptFilename(DESIGNPATH.'_js_libs/xajax/xajax_core.js'), 'xajax');
//			
//			if (true === $this->bDebug)
//				$aJsFiles[] = array($this->_getScriptFilename(DESIGNPATH.'_js_libs/xajax/xajax_debug.js'), 'xajax.debug');
//			
//			if (true === $this->bVerboseDebug)
//				$aJsFiles[] = array($this->_getScriptFilename(DESIGNPATH.'_js_libs/xajax/xajax_verbose.js'), 'xajax.debug.verbose');
//			
//			if (null !== $this->sLanguage)
//				$aJsFiles[] = array($this->_getScriptFilename(DESIGNPATH.'_js_libs/xajax/xajax_lang_' . $this->sLanguage . '.js'), 'xajax');
//		}
//		
