...
class pdf extends TCPDF
{
	...
	public function Footer ()
	{
		...
		$this->Cell((strlen($this->footerMessage) ? 60 : 0), 0, "{$this->registry->core->getMessage('TXT_PDF_PAGE_NUMBER')} {$this->getAliasNumPage()} {$this->registry->core->getMessage('TXT_PDF_PAGE_OUT_OF')} {$this->getAliasNbPages()}", 0, 1, (strlen($this->footerMessage) ? 'R' : 'C'));
	}
