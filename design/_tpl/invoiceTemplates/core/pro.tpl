			...
			<td align="right">
				<table style="border: 1px solid green;">
					...
					<tr valign="middle" bordercolor="red">
						<td align="left"><font size="7" color="grey">{trans}TXT_INVOICE_DATE{/trans}: {$invoiceData.invoicedate}</font></td>
						<td align="left"><font size="7" color="grey">{trans}TXT_SALE_DATE{/trans}: {$order.order_date}</font></td>
					</tr>
					<tr valign="middle">
						<td align="left"><font size="7" color="grey">{trans}TXT_MATURITY{/trans}: {$invoiceData.duedate}</font></td>
						<td align="left"><font size="7" color="grey">{trans}TXT_PAYMENT_METHOD{/trans}:<br />{$order.payment_method.paymentname}</font></td>
					</tr>
					<tr>
			...
			<td align="left">
				<table border="1">
					<tr>
						...
						<td align="left" width="30%"><small><b>{trans}TXT_PRODUCT_NAME{/trans}</b></small></td>
					...
					<tr>
						...
						<td align="center" width="5%"><font color="grey"><small></small></font></td>
					...
					<tr>
						<td align="right" width="45%" colspan="4"><font color="grey">{trans}TXT_TOGETHER{/trans}</font></td>
					...
					<tr>
						<td align="right" width="45%" colspan="4"><font color="grey">{trans}TXT_CONTAIN{/trans}</font></td>
						<td align="center" width="10%"><font color="grey"><small>{$summary[s].vat} %</small></font></td>
						<td align="center" width="15%"><font color="grey"><small>{price}{$summary[s].netto}{/price}</small></font></td>
						<td align="center" width="10%"><font color="grey"><small>{price}{$summary[s].vatvalue}{/price}</small></font></td>
						<td align="center" width="20%"><font color="grey"><small>{price}{$summary[s].brutto}{/price}</small></font></td>
					</tr>	
					{/section}
				</table>
			</td>
...
<div id="pricesumary" align="right">
	<table border="0" align="right">
		<tr>
			<td align="right"><font size="8" color="grey">{trans}TXT_IN_WORDS{/trans}: {$amountInWords} </font></td>
		</tr>
	</table>
</div>
<div id="asign">
