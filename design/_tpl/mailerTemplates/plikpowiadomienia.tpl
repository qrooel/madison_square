      ...
      <tr>
        <td height="96" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="60" align="left" valign="middle"><font color="#969696"><a href="#">{trans}TXT_CONTACT{/trans}</a></font></td>
            <td width="79" align="left" valign="middle"><font color="#969696"><a href="#">{trans}TXT_YOUR_ACCOUNT{/trans}</a></font></td>
            <td width="75" align="left" valign="middle"><font color="#969696"><a href="#">{trans}TXT_HELP{/trans}</a></font></td>
          </tr>
        </table></td>
      </tr>
      <tr>
