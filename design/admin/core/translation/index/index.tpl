<h2><img src="{$DESIGNPATH}_images_panel/icons/modules/translation-list.png" alt=""/>{trans}TXT_TRANSLATIONS_LIST{/trans}</h2>

<ul class="possibilities">
	<li><a href="{$URL}{$CURRENT_CONTROLLER}/add" class="button"><span><img src="{$DESIGNPATH}_images_panel/icons/buttons/add.png" alt=""/>{trans}TXT_ADD_TRANSLATION{/trans}</span></a></li>
</ul>
