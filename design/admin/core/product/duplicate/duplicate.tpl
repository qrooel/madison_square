<h2><img src="{$DESIGNPATH}_images_panel/icons/modules/product-duplicate.png" alt=""/>{trans}TXT_DUPLICATE_PRODUCT{/trans}</h2>
<ul class="possibilities">
	...
	<li><a href="#duplicate_product" rel="reset" class="button"><span><img src="{$DESIGNPATH}_images_panel/icons/buttons/clean.png" alt=""/>{trans}TXT_START_AGAIN{/trans}</span></a></li>
	<li><a href="#duplicate_product" rel="submit" class="button"><span><img src="{$DESIGNPATH}_images_panel/icons/buttons/check.png" alt=""/>{trans}TXT_SAVE{/trans}</span></a></li>
</ul>
