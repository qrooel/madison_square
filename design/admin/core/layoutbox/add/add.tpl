<h2><img src="{$DESIGNPATH}_images_panel/icons/modules/layoutbox-add.png" alt=""/>{trans}TXT_LAYOUT_BOX_ADD{/trans}</h2>
<ul class="possibilities">
	...
	<li><a href="#add_layoutbox" rel="reset" class="button"><span><img src="{$DESIGNPATH}_images_panel/icons/buttons/clean.png" alt=""/>{trans}TXT_START_AGAIN{/trans}</span></a></li>
	<li><a href="#add_layoutbox" rel="submit" class="button"><span><img src="{$DESIGNPATH}_images_panel/icons/buttons/check.png" alt=""/>{trans}TXT_SAVE{/trans}</span></a></li>
</ul>
