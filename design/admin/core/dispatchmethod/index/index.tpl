<h2><img src="{$DESIGNPATH}_images_panel/icons/modules/dispatchmethod-list.png" alt=""/>{trans}TXT_DISPATCHMETHODS_LIST{/trans}</h2>

<ul class="possibilities">
	<li><a href="{$URL}{$CURRENT_CONTROLLER}/add" class="button"><span><img src="{$DESIGNPATH}_images_panel/icons/buttons/add.png" alt=""/>{trans}TXT_ADD_DISPATCHMETHOD{/trans}</span></a></li>
</ul>
...
<script type="text/javascript">
   ...
   $(document).ready(function() {
		...
		var column_countries = new GF_Datagrid_Column({
			...
			caption: '{/literal}{trans}TXT_COUNTRY{/trans}{literal}',
		});
