 ...
 * $Id: showcasebox.php 655 2012-04-24 08:51:44Z gekosale $
 */

class ShowcaseBoxModel extends ModelWithDataset
{
	...
	{
		$Image = App::getModel('gallery')->getMediumImageById($id);
	...
	public function getCategories ($params)
	{
		$sql = 'SELECT
					...
					LEFT JOIN viewcategory VC ON C.idcategory= VC.categoryid
					LEFT JOIN product P ON PC.productid= P.idproduct
					WHERE VC.viewid = :viewid AND P.status = :statusid
					GROUP BY PC.categoryid';
		$stmt = $this->registry->db->prepareStatement($sql);
		$stmt->setInt('languageid', Helper::getLanguageId());
		$stmt->setInt('viewid', Helper::getViewId());
		$stmt->setInt('statusid', $params['statusId']);
		$rs = $stmt->executeQuery();
		$Data = Array();
		$Data[] = Array(
			'id' => 0,
			'caption' => $this->registry->core->getMessage('TXT_ALL')
		);
		while ($rs->next()){
			$Data[] = Array(
				'id' => $rs->getInt('id'),
